...
void main() {
  group('CartLine', () {
    ...
    test(
      'normalizes selectedOptions order by option id and makes list unmodifiable',
      () {
        final source = [
        ...
        expect(line.selectedOptions.map((s) => s.option.id).toList(), [
          'o1',
          'o2',
        ]);
    ...
    test(
      'toString includes product id, quantity, and normalized option ids',
      () {
        final line = CartLine(
          product: Product(id: 'p1', price: 10),
          quantity: 2,
          selectedOptions: [
            CartSelectedOption(
              option: ProductOption(id: 'o2', price: 2),
              quantity: 1,
            ),
            CartSelectedOption(
